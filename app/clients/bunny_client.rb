...
# API docs comes from https://docs.bunny.net/reference/bunnynet-api-overview
class BunnyClient
  ...
  # http_request(Net::HYYP::Post, "/videos", body: {})
  def http_request(method, path, body: nil)
    ...
    if response.is_a?(Net::HTTPSuccess)
      ...
      raise StandardError, "HTTP request failed with status #{response.code}"
    end
  end
end
